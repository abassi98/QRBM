   program main
      ...
      implicit none
      type(sRBM) :: Net
      integer :: Nv,N_sweeps,N_samples, steps, model, alpha, N_av, NN, ii,jj
      ...
      call s_init(Net, Nv, alpha, spin= dble(1.0))
      ...
      call S_SR(Net, model, h, pbc, steps, N_sweeps, N_samples, E, debug)
      ...
      do ii=1, Nv
         write(12,*) (Net%W(ii,jj), jj=1,alpha)
      enddo
      ...
      print *, "Symmetric RBM computation time (s): ", finish-start
